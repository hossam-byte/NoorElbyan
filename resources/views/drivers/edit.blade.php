<x-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{ route('drivers.update', $driver->id) }}" method="POST" class="card" id="classForm">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-8 mx-auto">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="form-label" for="name">اسم السائق</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input required type="number" id="number_of_seats" name="number_of_seats"
                                            min="0" class="form-control"
                                            value='{{ $driver->number_of_seats }}' />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="taken_seats">العدد المشغول</label>
                                        <input required type="number" id="taken_seats" name="taken_seats"
                                            min="0" class="form-control" value='{{ $driver->taken_seats }}' />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="available_seats">العدد المتاح</label>
                                        <input required type="number" id="available_seats" name="available_seats"
                                            min="0" class="form-control"
                                            value='{{ $driver->available_seats }}' />
                                    </div>
                                </div>
